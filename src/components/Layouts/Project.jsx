    ...
    <div className="max-w-full bg-gradient-to-b from-cyan-50 to-transparent">
      <div className="max-w-5xl mx-auto py-24">
        <div className="flex items-center gap-x-4 max-lg:px-5">
          <div className="bg-blue-100/50 w-9 h-9 flex items-center justify-center rounded-md border border-blue-200/50">
        ...
        <div className="mx-5 mb-12 sm:ml-[4.5rem] lg:ml-[3.20rem] block lg:flex px-6 sm:px-10 py-9 text-cyan-800 border-l-2 border-t-2 border-blue-300 border rounded-2xl bg-gradient-to-br from-transparent via-blue-50 to-blue-100">
          <div className="pr-10">
        ...
        <div className="mx-5 mb-12 sm:ml-[4.5rem] lg:ml-[3.20rem] block lg:flex px-6 sm:px-10 py-9 text-cyan-800 border-l-2 border-t-2 border-emerald-200 border rounded-2xl bg-gradient-to-br from-transparent via-emerald-50 to-emerald-100">
          <div className="pr-10">
        ...
        <div className="mx-5 mb-12 sm:ml-[4.5rem] lg:ml-[3.20rem] block lg:flex px-6 sm:px-10 py-9 text-cyan-800 border-l-2 border-t-2 border-red-200 border rounded-2xl bg-gradient-to-br from-transparent to-red-50">
          <div className="pr-10">
            <h2 className="flex items-center gap-x-3 text-2xl font-figtree tracking-tight font-bold">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-7 h-7">
